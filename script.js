...
(function () {
    ...
    imageCardBox.addEventListener("mouseenter", function () {
        ...
        imageCardBox.classList.add("hovering");
    ...
    imageCardBox.addEventListener("mouseleave", function () {
        currentScale = 1;
        imageCardBox.classList.remove("hovering");
...
function showFail() {
    ...
    posterImg.onload = null;
    posterImg.onerror = null;
    posterPlaceholder.textContent = "-_-";
    posterBg.classList.remove("show");
    posterRatio = defaultRatio;
    resizeCard(defaultRatio);
...
loginSubmitBtn.addEventListener("click", function () {
    ...
    if (!identifier || !password) {
        loginError.textContent = "c'mon fill in both fields.";
        return;
    }
...
signupSubmitBtn.addEventListener("click", function () {
    ...
    if (!username || !email || !password) {
        signupError.textContent = "c'mon fill in all fields.";
        return;
    }
...
function loadSavedList() {
    ...
    savedListEmpty.textContent = "Dude, You haven't saved anything yet.";
    ...
    fetch("Backend/get_saved_items.php?type=" + savedListActiveType)
        ...
        .catch(function () {
            savedListEmpty.textContent = "Couldn't load your list buddy. Try again later.";
            savedListEmpty.style.display = "block";
        });
}
